...
const Playlist = ({user, accessToken, selectedTrack, setSelectedTrack, tracks, setTracks, progress, setProgress}) => {
    ...
    return ( 
        <div id="playlist">
            {tracks.length ? (tracks.map(track => (
                <Track key={uuidv4()} track={track} tracks={tracks} setTracks={setTracks} 
                selectedTrack={selectedTrack} setSelectedTrack={setSelectedTrack} progress={progress}
